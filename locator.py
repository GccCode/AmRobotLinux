...
class AmazonAsinPageLocator(AmazonPageLocator):
    ...
    NOTHANKSAFTERCART = (By.ID, 'attachSiNoCoverage')
    ...
    QATEXT = (By.CSS_SELECTOR, 'input[name=\'askQuestionText\'')
